...
- Order hash keys before diffing to improve diff accuracy when using mocked calls. (James Crisp,
  #334)
...
- Work around bug in JRuby that reports that `attr_writer` methods have no parameters, causing
