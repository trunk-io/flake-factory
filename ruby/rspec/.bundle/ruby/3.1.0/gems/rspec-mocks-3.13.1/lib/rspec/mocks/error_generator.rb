  ...
  module Mocks
    ...
    class ErrorGenerator
      ...
      def default_error_message(expectation, expected_args, actual_args)
        "#{intro} received #{expectation.message.inspect} #{unexpected_arguments_message(expected_args,
                                                                                         actual_args)}".dup
      end
      ...
      def raise_expectation_error(message, expected_received_count, argument_list_matcher,
        ...
        expected_part = expected_part_of_expectation_error(expected_received_count, expectation_count_type,
                                                           argument_list_matcher)
        received_part = received_part_of_expectation_error(actual_received_count, args)
        __raise "(#{intro(:unwrapped)}).#{message}#{format_args(args)}\n    #{expected_part}\n    #{received_part}",
                backtrace_line, source_id
      end
