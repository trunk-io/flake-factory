  ...
  module Mocks
    ...
    class SimpleMessageExpectation
      def initialize(message, response, error_generator, backtrace_line = nil)
        @message, @response, @error_generator, @backtrace_line = message.to_sym, response, error_generator,
backtrace_line
        @received = false
      end
    ...
    class MessageExpectation
      ...
      def and_return(first_value, *values)
        ...
        @expected_received_count = [@expected_received_count,
                                    values.size].max unless ignoring_args? || (@expected_received_count == 0 && @at_least)
      ...
      def and_invoke(first_proc, *procs)
        ...
        @expected_received_count = [@expected_received_count,
                                    procs.size].max unless ignoring_args? || (@expected_received_count == 0 && @at_least)
      ...
      def to_s
        args_description = error_generator.method_call_args_description(@argument_list_matcher.expected_args, "", "") {
          true
        }
